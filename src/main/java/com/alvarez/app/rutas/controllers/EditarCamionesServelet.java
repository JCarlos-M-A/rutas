...
public class EditarCamionesServelet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(id > 0){
            ...
            if(c.isPresent()){
                ...
                req.setAttribute("camion", camion);
                getServletContext()
                        .getRequestDispatcher("/editarCamion.jsp")
                        .forward(req, resp);
            }else{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Camion camion = new Camion();
        camion.setId(Long.parseLong(req.getParameter("id")));
        ...
        if (errores.isEmpty()) {
            ...
            List<Marcas> marcas = new ArrayList<>(EnumSet.allOf(Marcas.class));
            req.setAttribute("marcas", marcas);
            getServletContext().getRequestDispatcher("/editarCamion.jsp")
                    .forward(req, resp);
        }
    }
}
